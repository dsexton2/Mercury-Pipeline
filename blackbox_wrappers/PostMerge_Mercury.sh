...
do
	...
	DIR_BAM=`ls $DIR_BAM_IN/*dups.bam`   ### Comment this back in if the path does not contain the bam ###
...
echo "samtools index ${BAM}" | msub -q normal -d ${DIR}  -V -l nodes=1:ppn=2,mem=8000mb -N ${FC}_index2
sleep 3
